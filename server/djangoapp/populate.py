...
def initiate():
    ...
    car_make_data = [
        ...
        {"name": "Toyota", "description": "Great cars. Japanese technology"},
        {
            "name": "Hyundai",
            "description":
                "Un constructeur automobile coréen qui " +
                "s'est imposé comme une marque mondiale " +
                "de renommée. Qualité, design, innovation " +
                "et fiabilité sont les maîtres-mots de Hyundai."
        },
    ]
    ...
    car_model_data = [
        ...
        {"name": "Kluger", "type": "SUV", "year": 2023,
            "car_make": car_make_instances[4]},
        {"name": "RAV4", "type": "HYBRID", "year": 2024,
            "car_make": car_make_instances[4]},
        {"name": "BZ4", "type": "ELECTRIC", "year": 2024,
            "car_make": car_make_instances[4]},
        {"name": "EV4", "type": "ELECTRIC", "year": 2023,
            "car_make": car_make_instances[3]},
        {"name": "Ioniq 5", "type": "ELECTRIC", "year": 2023,
